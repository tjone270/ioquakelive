...
vidmode_t r_vidModes[] =
    {
        ...
        {"Mode  3: 960x720", 960, 720, 1},
        {"Mode  4: 1024x768", 1024, 768, 1},
        {"Mode  5: 1152x864", 1152, 864, 1},
        {"Mode  6: 1280x1024", 1280, 1024, 1},
        {"Mode  7: 1600x1200", 1600, 1200, 1},
        {"Mode  8: 1920x1080", 1920, 1080, 1},
        {"Mode  9: 2048x1536", 2048, 1536, 1},
        {"Mode 10: 2560x1440", 2560, 1440, 1},
        {"Mode 11: 2560x1600", 2560, 1600, 1}};
...
void GfxInfo_f(void) {
    ...
    if (qglGetStringi) {
        ...
        for (i = 0; i < numExtensions; i++) {
            ri.Printf(PRINT_DEVELOPER, "%s ", qglGetStringi(GL_EXTENSIONS, i));
        }
    } else {
